<x-layout>
  ...
  <div class="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-800">
      ...
      <form action="/single-movie/{{$movie->movie_slug}}" method="POST">
        @csrf
        @method('PUT')
        <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
          ...
          <div class="sm:col-span-9">
            <div class="space-y-2">
              <select id="category_id" name="duration" value="{{old('duration', $movie->duration)}}" required class="py-2 px-3 pe-9 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-green-500 focus:ring-green-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
          ...
          <div class="sm:col-span-9">
            <input id="af-account-email" type="text" value="{{old('price', $movie->price)}}" name="price"  placeholder="The movie price..." class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-green-500 focus:ring-green-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
          </div>
